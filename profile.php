...
$iquery="select * from form1";
 $input= mysqli_query($con, $iquery);
?>
<?php include 'dbconn.php';
$jquery="select * from form2";

   $inputt= mysqli_query($con, $jquery);
?>
<!DOCTYPE html>
<html>
<head>
...
<hr>
	...
	<?php
while($rows=mysqli_fetch_assoc($inputt))
{
...
<div class="float-right" style="margin-left: -200%; margin-right: 5%; ">
	...
	<p><?php echo $rows['Project']; ?></p>
</div>
<div class="form-group">
	<h6><i class="fas fa-hospital-alt"></i>Resources</h6>
	<p><?php echo $rows['Resources']; ?></p>

<div class="float-right" style="margin-right: 0%;">
...
<div class="form-group">
	<h6><i class="fas fa-university"></i>Team</h6>
	<p><?php echo $rows['Team']; ?></p>
</div>

<div class="float-center" style="text-align: center;">
	<h6><i class="fas fa-university"></i>scope</h6>
	<p><?php echo $rows['Scope']; ?></p>
</div>
...
?> 
       ...
       <!-- Setting tab start -->
	<?php
while($rows=mysqli_fetch_assoc($input))
{
...
<div class="tab-pane fade p-5" id="setting-tab">
 ...
 <h4 class="text-center">Your Info </h4>
	...
	<h6>Roll_no</h6>
	<p><?php echo $rows['Roll_no']; ?><a href="#" class="float-right"></a></p>
	<h6>Phone: </h6>
