...
$query="select * from profilem where email='{$_SESSION['email']}'";
...
{$_SESSION['post'] = $rows['post'];
{$_SESSION['special'] = $rows['special'];
...
<li class="nav-item"><a href="#help-tab" class="nav-link" data-toggle="pill">Help</a></li>
  ...
  <!-- All Tabs Main div -->
   ...
   <img src="<?php echo $_SESSION['img']; ?>" width="150px" height="150px" class="rounded-circle border border-primary mx-auto d-flex my-2">
