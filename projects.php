...
if(isset($_POST['submit']))
{
 ...
 $team = mysqli_real_escape_string($con, $_POST['team']);
   ...
   $requirement = mysqli_real_escape_string($con, $_POST['requirement']);
    ...
    {
  $insertquery ="insert into project( Name, Email , Mobile,title,category,description,stream,team,exp,skills,requirement) 
  values('$Name','$Email' ,'$Mobile','$title','$category','$description','$stream','$team','$exp',
'$skills','$requirement')";
...
<div class="mobile-div">
	...
	<div class="team-div">
     	...
     	<div class="requirement-div">
			...
			<div class="input-div"><input type="input" name="requirement" placeholder="Your answer"></div>

</div>

  	<div class="exp-div">
			<div class="name">Experience:-</div>
			<div class="input-div"><input type="input" name="exp" placeholder="Your answer"></div>

</div>

 	<div class="skills-div">
			<div class="name">Skills needed:-</div>
			<div class="input-div"><input type="input" name="skills" placeholder="Your answer"></div>

</div>

		<button type="submit" name="submit" class="button">
			<span>Continue to Up-rise</span>
		</button>
</form>
